...
public class ShowLeftTipsPopupActivity extends AppCompatActivity {

    public static void start(Context context) {
        Intent intent = new Intent(context, ShowLeftTipsPopupActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_left_tips);
        ...
        triangleTipsView.setTriangleGravity(TriangleTipsView.TriangleGravity.LEFT);
