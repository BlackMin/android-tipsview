...
public class ShowTopTipsPopupActivity extends AppCompatActivity {

    public static void start(Context context) {
        Intent intent = new Intent(context, ShowTopTipsPopupActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_top_tips);
        ...
        triangleTipsView.setTriangleGravity(TriangleTipsView.TriangleGravity.TOP);
